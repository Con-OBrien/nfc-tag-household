...
const NFCReaderService_1 = require("../../src/services/NFCReaderService");
describe('NFCReaderService', () => {
    ...
    beforeEach(() => {
        service = new NFCReaderService_1.NFCReaderService();
    });
    describe('validateTagSignature', () => {
        ...
        it('should use constant-time comparison to prevent timing attacks', () => {
            ...
            const timeDiff = Math.abs(Number(time1) - Number(time2)) / 1000000; // Convert to ms
    ...
    describe('generateTagSignature', () => {
        ...
        it('should generate different signatures for different data', () => {
            const sig1 = service.generateTagSignature(validTagData, householdSecret);
            const sig2 = service.generateTagSignature({ ...validTagData, taskId: 'task_002' }, householdSecret);
