...
describe('UserRepository Properties - Household Isolation', () => {
    ...
    it('should enforce household isolation for findUsersInHousehold', () => {
        return fast_check_1.default.assert(fast_check_1.default.asyncProperty(fast_check_1.default.tuple(fast_check_1.default.array(fast_check_1.default.record({
            householdId: fast_check_1.default.uuid(),
            userName: fast_check_1.default.string({ minLength: 1, maxLength: 50 }),
            email: fast_check_1.default.string({ minLength: 5, maxLength: 50 }),
            userCount: fast_check_1.default.integer({ min: 1, max: 5 }),
        }), { minLength: 2, maxLength: 5 })), async ([householdSpecs]) => {
            ...
            for (const spec of householdSpecs) {
                const usersInHousehold = await userRepository.findUsersInHousehold(spec.householdId);
    ...
    it('should return empty results for cross-household queries', () => {
        return fast_check_1.default.assert(fast_check_1.default.asyncProperty(fast_check_1.default.tuple(fast_check_1.default.uuid(), fast_check_1.default.uuid(), fast_check_1.default.integer({ min: 1, max: 5 })), async ([householdA, householdB, userCount]) => {
    ...
    it('should enforce household filtering at database query level', () => {
        return fast_check_1.default.assert(fast_check_1.default.asyncProperty(fast_check_1.default.tuple(fast_check_1.default.uuid(), fast_check_1.default.uuid()), async ([householdX, householdY]) => {
            // Ensure households are different
    ...
    it('should prevent users from household A accessing household B data', () => {
        return fast_check_1.default.assert(fast_check_1.default.asyncProperty(fast_check_1.default.tuple(fast_check_1.default.uuid(), // householdA
        fast_check_1.default.uuid(), // householdB
        fast_check_1.default.integer({ min: 1, max: 3 }), // users in A
        fast_check_1.default.integer({ min: 1, max: 3 }) // users in B
    ...
    it('should maintain isolation across different query methods', () => {
        return fast_check_1.default.assert(fast_check_1.default.asyncProperty(fast_check_1.default.tuple(fast_check_1.default.uuid(), fast_check_1.default.uuid()), async ([householdA, householdB]) => {
            expect(householdA !== householdB).toBe(true);
            ...
            const foundByEmail = await userRepository.findByEmail('unique@example.com', householdB);
    ...
    it('should enforce household isolation even with role filtering', () => {
        return fast_check_1.default.assert(fast_check_1.default.asyncProperty(fast_check_1.default.tuple(fast_check_1.default.uuid(), // householdA
        fast_check_1.default.uuid(), // householdB
        fast_check_1.default.integer({ min: 1, max: 2 }) // owner count
    ...
    it('should enforce isolation when updating preferences', () => {
        return fast_check_1.default.assert(fast_check_1.default.asyncProperty(fast_check_1.default.tuple(fast_check_1.default.uuid(), fast_check_1.default.uuid()), async ([householdA, householdB]) => {
            ...
            await expect(userRepository.updateUserPreferences(userA.userId, householdB, {
