...
describe('TaskRepository', () => {
    ...
    const createMockTaskEntity = (overrides = {}) => {
    ...
    describe('findTaskById', () => {
        ...
        it('should throw ValidationError when taskId is missing', async () => {
            await expect(taskRepository.findTaskById('', mockHouseholdId)).rejects.toThrow(types_1.ValidationError);
        });
        it('should throw ValidationError when householdId is missing', async () => {
            await expect(taskRepository.findTaskById(mockTaskId, '')).rejects.toThrow(types_1.ValidationError);
        });
    });
    describe('findTasksByHousehold', () => {
        ...
        it('should throw ValidationError when householdId is missing', async () => {
            await expect(taskRepository.findTasksByHousehold('')).rejects.toThrow(types_1.ValidationError);
        });
    ...
    describe('createTask', () => {
        ...
        it('should throw ValidationError when name is missing', async () => {
            ...
            await expect(taskRepository.createTask(newTask)).rejects.toThrow(types_1.ValidationError);
        });
        ...
        it('should throw ValidationError when required fields are missing', async () => {
            ...
            await expect(taskRepository.createTask(missingNameTask)).rejects.toThrow(types_1.ValidationError);
        });
    });
    describe('updateTask', () => {
        ...
        it('should throw NotFoundError when task does not exist', async () => {
            ...
            await expect(taskRepository.updateTask(mockTaskId, mockHouseholdId, updates)).rejects.toThrow(types_1.NotFoundError);
        });
        it('should validate updated name length', async () => {
            ...
            mockRepository.findOne.mockResolvedValue(existingTask);
            await expect(taskRepository.updateTask(mockTaskId, mockHouseholdId, updates)).rejects.toThrow(types_1.ValidationError);
        });
        it('should throw ValidationError when taskId or householdId is missing', async () => {
            const updates = { name: 'Updated Name' };
            await expect(taskRepository.updateTask('', mockHouseholdId, updates)).rejects.toThrow(types_1.ValidationError);
            await expect(taskRepository.updateTask(mockTaskId, '', updates)).rejects.toThrow(types_1.ValidationError);
        });
    ...
    describe('deactivateTask', () => {
        it('should set isActive to false', async () => {
            ...
            const deactivatedTask = new Task_1.TaskEntity();
        ...
        it('should throw NotFoundError when task does not exist', async () => {
            mockRepository.findOne.mockResolvedValue(null);
            await expect(taskRepository.deactivateTask(mockTaskId, mockHouseholdId)).rejects.toThrow(types_1.NotFoundError);
        });
        it('should throw ValidationError when taskId or householdId is missing', async () => {
            await expect(taskRepository.deactivateTask('', mockHouseholdId)).rejects.toThrow(types_1.ValidationError);
            await expect(taskRepository.deactivateTask(mockTaskId, '')).rejects.toThrow(types_1.ValidationError);
        });
