...
class APNsService {
     ...
     */
    constructor(certificatePath, keyPath, teamId, keyId, bundleId) {
     ...
     */
    async simulateAPNsDelivery(pushToken, payload) {
        ...
        if (pushToken.startsWith('test_fail')) {
            ...
            if (pushToken.startsWith('test_failexpir'))
                failureType = 'expired';
            else if (pushToken.startsWith('test_failauth'))
                failureType = 'auth';
            else if (pushToken.startsWith('test_failrate'))
                failureType = 'rate';
            else if (pushToken.startsWith('test_failinvalid'))
                failureType = 'invalid';
            else if (pushToken.startsWith('test_failunavail'))
