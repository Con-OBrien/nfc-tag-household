 ...
 */
router.post('/households/:householdId/tasks', authenticateUser, (req, res, next) => taskController.createTask(req, res, next));
/**
 * PUT /api/households/:householdId/tasks/:taskId
 * Update an existing task
 */
router.put('/households/:householdId/tasks/:taskId', authenticateUser, (req, res, next) => taskController.updateTask(req, res, next));
/**
 * DELETE /api/households/:householdId/tasks/:taskId
 * Deactivate a task (soft delete, preserves events)
 */
router.delete('/households/:householdId/tasks/:taskId', authenticateUser, (req, res, next) => taskController.deactivateTask(req, res, next));
/**
 ...
 */
router.get('/households/:householdId/tasks', authenticateUser, (req, res, next) => taskController.listTasks(req, res, next));
/**
 * GET /api/households/:householdId/tasks/:taskId
 * Get a single task by ID
 */
router.get('/households/:householdId/tasks/:taskId', authenticateUser, (req, res, next) => taskController.getTask(req, res, next));
